...
export const constantRouterMap = [
  ...
  { path: '/401', component: _import('errorPage/401'), hidden: true },
  {
    ...
    children: [
      {
        path: 'employee',
        component: _import('system/employee'),
        name: 'employee',
        meta: { title: '员工管理', icon: 'dashboard', noCache: true }
      },
      {
        path: 'employeeEdit/:id(\\d+)',
        component: _import('system/employeeEdit'),
        name: 'employeeEdit',
        meta: { title: '员工修改', icon: 'dashboard', noCache: true },
        hidden: true
      },
    ]
  },
