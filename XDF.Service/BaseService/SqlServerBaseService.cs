...
{
    public class SqlServerBaseService<T> where T : class
    {
        public static readonly string Key = typeof(T).Name;
        public SqlServerBaseDao<T> BaseCrudDao = null;
        #region CRUD
        ...
        public virtual T Insert(T info)
        {
            return BaseCrudDao.Insert<T>(info);
        }
