...
namespace XDF.Core.Helper.Ext
{
    ...
    {
        private static List<string> Surname { get; } = new List<string>
        {
            "赵",
            "钱",
            "孙",
        ...
        private static object[] CreateRegionCode(int strlength, bool isRandomCount = false)
        {
            if(isRandomCount) {
            ...
            */
            for (var i = 0; i < strlength; i++) {
                ...
                //区位码第2位
                rnd = new System.Random(r1 * unchecked((int) DateTime.Now.Ticks) + i); //更换随机数发生器的种子避免产生重复值
                int r2;
                ...
                var byte1 = Convert.ToByte(str_r1 + strR2, 16);
        ...
        {
            var random = new System.Random();
            var index = random.Next(0, Surname.Count());
        ...
        public static string CreateName()
        {
            ...
            foreach (var t in bytes) {
                name += gb.GetString((byte[]) Convert.ChangeType(t, typeof(byte[])));
            }
            return $"{surname}{name}";
        }
    }
